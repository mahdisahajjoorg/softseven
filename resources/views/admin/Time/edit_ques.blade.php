   ...
   <section class="panel">
    ...
    @endif
            ...
            <div class="panel-body">
                ...
                <form  class="form-horizontal"  method="post" action="{{route('question.update_time_question_form_submit')}}" enctype="multipart/form-data">	
                    @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="contest" class="form-control input-lg" required="required" id="QuestionContest">
                        	<option value="<?php echo $datas->id; ?>"><?php echo $datas->time_contest_name; ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="answer1" class="form-control input-lg" maxlength="255" value="<?php echo $datas->answer1; ?>" type="text" id="QuestionAnswer1"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="hint"  value="<?php echo $datas->hint; ?>" class="form-control input-lg" type="text" id="QuestionHint"/>
                    </div>
                </div>
            </div>
