...
<section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="answer2" class="form-control input-lg" maxlength="255" type="text" id="QuestionAnswer2"/>                   
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">Wrong Answer2</label>
                    <div class="col-sm-9">
                        <input name="answer3" class="form-control input-lg" maxlength="255" type="text" id="QuestionAnswer3"/>                   
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">Wrong Answer3</label>
                    <div class="col-sm-9">
                        <input name="answer4" class="form-control input-lg" maxlength="255" type="text" id="QuestionAnswer4"/>                 
                    </div>
                </div>
                <div class="form-group">
