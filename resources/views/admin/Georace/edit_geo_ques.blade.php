            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2"><button type="button" class="nrmodal" data-toggle="modal"
                            data-target="#myModal">Select From Gallery</button>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="contest" class="form-control input-lg" required="required" id="QuestionContest">
                        	...
                        	<option value="<?php echo $data->georace_contest_id; ?>"><?php echo $data->georace_contest_name; echo "_"; echo $data->georace_cat_name; ?>
                        	</option>
                        	@foreach($data2 as $info)
                        	<option value="<?php echo $info->id; ?>"><?php echo $info->georace_contest_name; echo "_"; echo $info->georace_cat_name; ?></option>
                        	@endforeach
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input name="answer1" class="form-control input-lg" maxlength="255" type="text" value="<?php echo $data->answer1; ?>" id="QuestionAnswer1"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">Wrong Answer1</label>
                    <div class="col-sm-9">
                        <input name="answer2" class="form-control input-lg" maxlength="255" type="text" value="<?php echo $data->answer2; ?>" id="QuestionAnswer2"/>                   
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">Wrong Answer2</label>
                    <div class="col-sm-9">
                        <input name="answer3" class="form-control input-lg" maxlength="255" value="<?php echo $data->answer3; ?>" type="text" id="QuestionAnswer3"/>                   
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">Wrong Answer3</label>
                    <div class="col-sm-9">
                        <input name="answer4" class="form-control input-lg" maxlength="255" value="<?php echo $data->answer4; ?>" type="text" id="QuestionAnswer4"/>                 
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">Hint</label>
                    <div class="col-sm-9">
                        <input name="hint" class="form-control input-lg" type="text" value="<?php echo $data->hint; ?>" id="QuestionHint"/>
                    </div>
                </div>
            </div>
