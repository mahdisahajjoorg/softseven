...
<section class="content-body" role="main">
  <div class="row">
    <div class="col-md-12">
        <form action="{{route('question.store_money_level_question_form')}}" id="summary-form" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="money_contest_name">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="money_cat_id" class="form-control input-lg" required="required" id="MoneylevelCategory">
                         @foreach($data as $cat)
						<option value="<?php echo $cat->money_cat_id; ?>"><?php echo $cat->money_cat_name; ?></option>
                        @endforeach
						</select>                    
					</div>
                </div>
                    ...
                    <div class="col-sm-9">
                        <input name="unlock_score" class="form-control input-lg" type="text" id="MoneylevelUnlockScore"/>                    </div>
                </div>
